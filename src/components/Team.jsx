    ...
    <div className="w-full">
      <div className="flex">
        <label className="relative block" htmlFor="search">
          ...
          <input
            className="placeholder:italic placeholder:text-gray-400 block bg-gray-100 w-full border border-gray-300 rounded-full py-2 pl-9 pr-3 mt-2 shadow-sm focus:outline-none focus:border-blue-800 focus:ring-blue-800 focus:ring-1 sm:text-sm"
            placeholder="Search"
            type="text"
            name="search"
            value={query}
